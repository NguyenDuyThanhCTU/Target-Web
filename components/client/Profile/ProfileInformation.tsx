...
const ProfileInformation = ({ showModal }: any) => {
  ...
  return (
    <div className="flex ">
          ...
          <div className="ml-5 border">
            <div className="p-2">
              ...
              <Form.Item<FormType> name="dateofbirth" label="Ngày sinh">
                <DatePicker placeholder={currentUser?.dateofbirth} />
              </Form.Item>
              ...
              <Form.Item<FormType> name="introduce" label="Giới thiệu">
                <TextArea rows={4} placeholder={currentUser?.introduce} />
              </Form.Item>
      ...
      <AccountInformation HeaderAdmin={Data} />
    </div>
  );
};
